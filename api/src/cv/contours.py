...
from api.src.models.predict_model import get_prediction_from_segmentation_model, get_octane_number_from_model
...
def find_molecules(img):
    contours = get_prediction_from_segmentation_model(image=img)
    octane_number = get_octane_number_from_model(image=img)
